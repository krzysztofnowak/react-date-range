...
var DayCell = /*#__PURE__*/function (_Component) {
  ...
  function DayCell(props, context) {
    ...
    _defineProperty(_assertThisInitialized(_this), "getClassNames", function () {
      ...
      return (0, _classnames4.default)(styles.day, (_classnames = {}, _defineProperty(_classnames, styles.dayPassive, isPassive), _defineProperty(_classnames, styles.dayDisabled, disabled), _defineProperty(_classnames, styles.dayToday, isToday), _defineProperty(_classnames, styles.dayWeekend, isWeekend), _defineProperty(_classnames, styles.dayStartOfWeek, isStartOfWeek), _defineProperty(_classnames, styles.dayEndOfWeek, isEndOfWeek), _defineProperty(_classnames, styles.dayStartOfMonth, !_this.props.selectablePassive && isStartOfMonth), _defineProperty(_classnames, styles.dayEndOfMonth, !_this.props.selectablePassive && isEndOfMonth), _defineProperty(_classnames, styles.dayHovered, _this.state.hover), _defineProperty(_classnames, styles.dayActive, _this.state.active), _classnames));
    });
...
DayCell.propTypes = {
  ...
  selectablePassive: _propTypes.default.bool
};
